...
export const CercleSvg = ({ className }) => {
  return (
    <svg
      className={className}
    ...
    >
      <path
        fill="#ffffff20"
        fillOpacity="1"
        d="M0,192L48,176C96,160,192,128,288,133.3C384,139,480,181,576,170.7C672,160,768,96,864,69.3C960,43,1056,53,1152,74.7C1248,96,1344,128,1392,144L1440,160V0H0Z"
      ></path>
    </svg>
  );
};
export const MobileMenuSvg = ({ className }) => {
  return (
    <svg
      className={className}
      fill="none"
  ...
  return (
    ...
    >
      <path
        fill="#ffffff20"
        fillOpacity="1"
        d="M0,224L48,208C96,192,192,160,288,149.3C384,139,480,149,576,170.7C672,192,768,224,864,229.3C960,235,1056,213,1152,181.3C1248,149,1344,107,1392,85.3L1440,64V320H0Z"
      ></path>
    </svg>
  );
};
export const BgBlueDotSvg = ({ className }) => {
  return (
    <svg
      className={className}
      width="48"
...
export const WebDevLogoSvg = ({ className }) => {
  return (
    <svg
      className={className}
      fill="none"
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M9.75 21h4.5a2.25 2.25 0 002.25-2.25v-3.5A2.25 2.25 0 0014.25 13h-4.5A2.25 2.25 0 007.5 15.25v3.5A2.25 2.25 0 009.75 21z"
      ></path>
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M9.75 13V7.5A2.25 2.25 0 0112 5.25a2.25 2.25 0 012.25 2.25V13"
      ></path>
    </svg>
  );
};
export const BgBlueDot = ({ className }) => {
  return (
    <svg
      className={className}
      width="48"
...
export const AboutBgSvg = ({ className }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const FooterBgSvg = ({ className }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
    ...
    >
      <path
        fill="#2d3748"
        fillOpacity="1"
        d="M0,128L48,122.7C96,117,192,107,288,101.3C384,96,480,96,576,122.7C672,149,768,203,864,213.3C960,224,1056,224,1152,213.3C1248,203,1344,149,1392,122.7L1440,96V0H0Z"
      ></path>
    </svg>
  );
};
...
export const GoogleIconSvg = ({ className }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export const StarIconSvg = ({ className }) => {
  return (
